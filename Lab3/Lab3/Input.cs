...
namespace Lab3
{
    ...
    //internal class InputDoCommand
    //{
    //    private InputModifierReceiver inputReceiver;
    //    private string inputUnit;

    //    public InputDoCommand(InputModifierReceiver inputReceiver, string inputUnit)
    //    {
    ...
    //    {
    //        inputReceiver.EditRegister(inputUnit);
    //    }
    //}
    ...
    internal class InputModifierReceiver
    {
        ...
        public void EditRegister(string inputUnit)
        {
            ...
            if (double.Parse(Register) % (int)(double.Parse(Register)) != 0) { isDotSet = true; }
